...
export function Features() {
  return (
    <section className="bg-base border-t border-muted-line">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mt-20 border-t border-muted-line">
          {features.map((f) => (
            ...
            >
              ...
              <div className="font-mono-ui text-[11px] tracking-[0.3em] text-cobalt">{f.name}</div>
              ...
              <p className="font-body text-ink-soft mt-6 text-[15px] leading-relaxed">{f.body}</p>
